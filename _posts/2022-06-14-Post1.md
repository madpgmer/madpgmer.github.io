...
<h5 align="left">Syntax:</h5> 
<p align="center"> <img width="500" height="300" src="https://i.imgur.com/SA72nbc.jpg"></p>   
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/7PhDXhcd-aA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
For some reason the embeded video is not responding(Firefox browsers usually🙄) try this <a href="https://www.youtube.com/watch?v=7PhDXhcd-aA">link</a>.
<br>
<div align="justify">
Now that you have a fair idea of setting up and getting started with MongoDB, be sure to look out for my next post where I will take you through the process of migrating one of my 3rd-semester web projects from MariaDB to MongoDB. See you on the other side. </div>
<br>
...
<br>
<p>
[MongoDB image]&nbsp;&nbsp;	_Simplilearn.com_, 2022. https://www.simplilearn.com/ice9/free_resources_article_thumb/What_is_MongoDB.PNG (accessed Jun. 15, 2022).</p>
